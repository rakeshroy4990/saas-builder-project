...
import { ChatFab } from '@realtime/index';
...
<template>
  <div id="app-shell-root" :class="shellRoot">
    <div class="pointer-events-none fixed right-3 top-3 z-50 flex justify-end">
  ...
  <ChatFab package-name="ecommerce" page-id="chat-popup" title="Chat" />
  <GlobalPopup />
  <GlobalToast />
</template>
