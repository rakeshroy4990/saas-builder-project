const DEFAULT_LOGO_URL =
  'https://res.cloudinary.com/dbke33vfd/image/upload/c_fill,h_80,w_80/v1776158879/logo_oz0zzd.jpg';
...
export function resolveBrandLogoUrl(appBaseUrl: string): string {
...
export function withBrandShell(contentHtml: string, appBaseUrl: string): string {
