...
const buttonAriaLabel = computed((): string | undefined => {
  const preset = props.config?.iconPreset;
    ...
    >
      <span class="inline-flex shrink-0" aria-hidden="true">
        <svg class="h-6 w-6" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
          <path
            fill="#FFC107"
            d="M43.611 20.083H42V20H24v8h11.303C33.376 32.658 29.288 36 24 36c-6.627 0-12-5.373-12-12s5.373-12 12-12c3.059 0 5.842 1.154 7.961 3.039l5.657-5.657C34.046 6.053 29.268 4 24 4 12.955 4 4 12.955 4 24s8.955 20 20 20 20-8.955 20-20c0-1.341-.138-2.65-.389-3.917z"
          />
          <path
            fill="#FF3D00"
