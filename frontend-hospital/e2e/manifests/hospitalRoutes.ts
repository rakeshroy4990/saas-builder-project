...
export const hospitalRouteManifest: HospitalRouteManifestEntry[] = [
  ...
  { packageName: 'hospital', pageId: 'blog' },
  ...
  { packageName: 'hospital', pageId: 'prescriptions' },
  ...
  { packageName: 'hospital', pageId: 'triage', skipRouteSmoke: true },
  { packageName: 'hospital', pageId: 'triage-soft-block-popup', skipRouteSmoke: true },
  ...
  { packageName: 'hospital', pageId: 'appointment-growth-popup', skipRouteSmoke: true },
